...
public class FabricUParser {
    ...
    private String processSetupLinkRequest(String input_str_val) {
        ...
        int password_len = EncodeNumber.decode(rest_str.substring(0, ProtocolDefineClass.DATA_LENGTH_SIZE));
        rest_str = rest_str.substring(ProtocolDefineClass.DATA_LENGTH_SIZE);
    ...
    private String generateSetupLinkResponse(String link_id_str_val, String my_name_val) {
        ...
        response_buf.append(EncodeNumber.encode(my_name_val.length(), ProtocolDefineClass.DATA_LENGTH_SIZE));
    ...
    protected String generateRemoveLinkResponse(String link_id_str_val, String result_val) {
        ...
        response_buf.append(link_id_str_val);
        response_buf.append(EncodeNumber.encode(result_val.length(), ProtocolDefineClass.DATA_LENGTH_SIZE));
    ...
    private String processGetLinkDataRequest(String input_str_val) {
        ...
        for (int i = 0; i <= max_session_table_array_index; i++) {
        	...
        	FabricLSession session = (FabricLSession)list_entry.data();
            if (session != null) {
    ...
    public String generateGetLinkDataResponse(String link_id_str_val, String data_val, String pending_session_setup_val) {
        ...
        response_buf.append(FabricExport.FABRIC_COMMAND_GET_LINK_DATA); 
        response_buf.append(link_id_str_val);
        response_buf.append(EncodeNumber.encode(data_val.length(), ProtocolDefineClass.DATA_LENGTH_SIZE));
        response_buf.append(data_val);
        response_buf.append(EncodeNumber.encode(pending_session_setup_val.length(), ProtocolDefineClass.DATA_LENGTH_SIZE));
    ...
    protected String generateGetNameListResponse(String link_id_str_val, String name_list_str_val) {
        ...
        response_buf.append(link_id_str_val);
        response_buf.append(EncodeNumber.encode(name_list_str_val.length(), ProtocolDefineClass.DATA_LENGTH_SIZE));
    ...
    private String processSetupSessionRequest(String input_str_val) {
        ...
        int his_name_len = EncodeNumber.decode(rest_str.substring(0, ProtocolDefineClass.DATA_LENGTH_SIZE));
        rest_str = rest_str.substring(ProtocolDefineClass.DATA_LENGTH_SIZE);
        ...
        FabricLSession session = link.mallocSession();
        ...
        if (his_name.equals(link.myName())) {
            ...
            FabricLSession his_session = his_link.mallocSession();
            if (his_session == null) {
    ...
    private String processSetupSession2Request(String input_str_val) {
        ...
        FabricLSession session = link.sessionMgr().getSessionByIdStr(session_id_str);
        if (session == null) {
    ...
    protected String generatePutSessionDataResponse(String link_id_str_val, String session_id_str_val, String c_data_val) {
        ...
        response_buf.append(link_id_str_val);
        response_buf.append(session_id_str_val);
        response_buf.append(EncodeNumber.encode(c_data_val.length(), ProtocolDefineClass.DATA_LENGTH_SIZE));
