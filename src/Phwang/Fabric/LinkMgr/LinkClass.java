...
public class LinkClass {
    ...
    public void SetPendingSessionSetup3(String browser_theme_id_str_val, String session_id_str_val, String theme_data_val) {
        this.debugIt(true, "********************SetPendingSessionSetup3", "browser_theme_id_str_val =" + browser_theme_id_str_val);
        this.debugIt(true, "********************SetPendingSessionSetup3", "session_id_str_val =" + session_id_str_val);
        this.debugIt(true, "********************SetPendingSessionSetup3", "theme_data_val =" + theme_data_val);
